...
namespace transport_catalogue::stat_reader
{
    ...
    std::ostream& ExecuteRequest(std::ostream&, TransportCatalogue&, RequestQuery&);    // Отправляет запрос и осуществляет вывод ответаquest(TransportCatalogue&, RequestQuery&);           // Отправляет запрос и осуществляет вывод ответа
